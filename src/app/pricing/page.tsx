...
const plans = [
  {
    ...
    features: [
      ...
      { name: "5 service & industry tags", included: true },
      { name: "1 lead credit/month", included: true },
      { name: "30-day analytics", included: true },
      { name: "Cover image & social links", included: false },
      { name: "Service packages", included: false },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Cover image & social links", included: true },
      { name: "Service packages", included: true },
      { name: "Team showcase", included: true },
      { name: "Lead notifications", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Highest search priority", included: true },
      { name: "50 lead credits/month", included: true },
      { name: "Unlimited team members", included: true },
      { name: "API access", included: true },
      { name: "Branded quote forms", included: true },
  ...
  },
  {
    ...
    features: [
      ...
      { name: "Highest search boost", included: true },
...
const faqStructuredData = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "We are setting up secure payment processing. In the meantime, contact us at support@listingproject.com to upgrade your plan.",
      },
    },
  ],
};
          ...
          <div className="space-y-6">
            {[
              ...
              },
              {
                ...
                a: "We are setting up secure payment processing. In the meantime, contact us at support@listingproject.com to upgrade your plan.",
              },
            ].map((faq) => (
